...
export default function DashboardPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-10 py-6 px-4">
        ...
        <form onSubmit={handleAnalyzeGoal} className="space-y-4">
          ...
          <div className="relative">
            <textarea
              ...
              placeholder="Search or describe what you need... e.g. 'I want to start a business in Vadodara' or 'Apply for higher education scholarship'..."
              className="w-full bg-slate-950 border border-slate-800 rounded-xl p-4 text-slate-100 placeholder-slate-500 focus:outline-none focus:border-amber-500/60 focus:ring-1 focus:ring-amber-500/60 text-sm resize-none"
            />
            <button
              type="submit"
              disabled={isAnalyzing || !goalInput.trim()}
              className="absolute bottom-4 right-4 bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-400 hover:to-orange-400 text-slate-950 font-bold px-5 py-2.5 rounded-lg text-sm flex items-center gap-2 shadow-lg disabled:opacity-50 transition"
            >
              {isAnalyzing ? (
                <>
      ...
      {/* Context Collection & Dynamic Document Matching Section */}
      {analysisResult && (
        <div className="bg-slate-900 border border-amber-500/30 rounded-2xl p-6 space-y-6 shadow-xl animate-fade-in">
          <div className="flex items-center justify-between">
            <div>
              <span className="text-xs font-semibold uppercase text-amber-400">Goal Classified</span>
            ...
            <div className="p-4 bg-slate-950 border border-slate-800 rounded-xl space-y-4">
              <div className="flex items-center justify-between border-b border-slate-800 pb-2">
                <h4 className="text-xs font-bold text-slate-200 uppercase tracking-wider flex items-center gap-2">
                  ...
                  <span>Personalized Document Requirements</span>
                </h4>
          ...
          {analysisResult.needs_location_clarification && (
            <div className="p-3 bg-amber-500/10 border border-amber-500/30 rounded-xl text-xs text-amber-200">
              ⚠️ <strong>Which city or state are you planning this in?</strong>
