...
export const ALL_CITIZENS: AdminCitizen[] = [
  {
    ...
    activeWorkflows: 1,
    lastGoal: 'PM-KISAN Farmer Direct Benefit Transfer (DBT)',
    profileCompletion: 85,
    lastActivity: 'Awaiting Land Record Khasra e-KYC Attestation',
    assignedTo: 'DISHITA',
    documents: [
      { name: 'Aadhaar Card', status: 'Verified' },
      { name: 'PAN Card', status: 'Verified' },
      { name: 'Domicile Certificate', status: 'Verified' },
      { name: 'Kisan Credit Card', status: 'Verified' },
      { name: 'Land Record Khasra', status: 'Pending' },
    ],
    applications: [
      { id: 'JS-2026-8801', service: 'PM-KISAN DBT Direct Support', status: 'SUBMITTED' },
    ],
    recentActivity: [
      'Application submitted - PM-KISAN DBT Direct Support',
      'Aadhaar e-KYC authenticated via UIDAI NSSO Node',
      'Ministry of Agriculture requested Land Record Khasra',
      'DPDP consent granted for Agriculture & Revenue depts',
    ],
  },
  {
    id: '1111 2222 1405',
    ...
    activeWorkflows: 2,
    lastGoal: 'National Apprenticeship Training Scheme (NATS) & Higher Education',
    profileCompletion: 90,
    lastActivity: 'Diploma Verification under review by Ministry of Education',
    assignedTo: 'DISHITA',
    documents: [
      { name: 'Aadhaar Card', status: 'Verified' },
      { name: 'PAN Card', status: 'Verified' },
      ...
      { name: 'Polytechnic Marksheet', status: 'Pending' },
      { name: 'Domicile Certificate', status: 'Verified' },
    ],
    applications: [
      { id: 'JS-2026-8802', service: 'National Apprenticeship Training Scheme (NATS)', status: 'UNDER_VERIFICATION' },
      { id: 'APP-2026-002', service: 'Commercial Trade Clearance', status: 'ACTIVE' },
    ],
    recentActivity: [
      'Application submitted - National Apprenticeship Training Scheme',
      'Goal analyzed - Technical Career & Skill Apprenticeship',
      'DPDP consent updated for Ministry of Education',
  ...
  },
  {
    ...
    activeApplications: 1,
    activeWorkflows: 1,
    lastGoal: 'PM Awas Yojana (PMAY-Gramin) Housing Support',
    profileCompletion: 84,
    lastActivity: 'Awaiting Geo-Tagged Site Inspection Photo',
    assignedTo: 'JYOTI',
    documents: [
      { name: 'Aadhaar Card', status: 'Verified' },
      { name: 'PAN Card', status: 'Verified' },
      { name: 'Income Certificate', status: 'Verified' },
      { name: 'BPL / SECC Card', status: 'Verified' },
      { name: 'Bank Passbook', status: 'Verified' },
      { name: 'Geo-Tagged Site Inspection Photo', status: 'Pending' },
    ],
    applications: [
      { id: 'JS-2026-8803', service: 'PM Awas Yojana (PMAY-Gramin)', status: 'DOCUMENTS_REQUIRED' },
    ],
    recentActivity: [
      'Application submitted - PM Awas Yojana (PMAY-Gramin)',
      'Rural Development department requested Geo-Tagged Site Photo',
      'SECC Beneficiary Priority Verified',
      'Bank Account Mandate Seeded with NPCI DBT',
    ],
  },
  {
    id: '1111 2222 3333',
    ...
    activeApplications: 2,
    activeWorkflows: 1,
    lastGoal: 'Ayushman Bharat PM-JAY & Post-Matric Scholarship',
    profileCompletion: 88,
    lastActivity: 'Ayushman Golden Card Approved & Issued to DigiLocker',
    assignedTo: 'JYOTI',
    documents: [
      { name: 'Aadhaar Card', status: 'Verified' },
      { name: 'PAN Card', status: 'Verified' },
      ...
      { name: '10th Marksheet', status: 'Verified' },
      { name: '12th Marksheet', status: 'Verified' },
      { name: 'Ayushman Bharat E-Card', status: 'Verified' },
      { name: 'Income & Domicile Certificate', status: 'Pending' },
    ],
    applications: [
      { id: 'JS-2026-8804', service: 'Ayushman Bharat PM-JAY Golden Card', status: 'APPROVED' },
    ],
    recentActivity: [
      'Ayushman Bharat PM-JAY Golden Card Dispatched to DigiLocker',
      'NFSA Ration Card matched with National Health Database',
      'Application approved & Disbursed',
      'Demographic e-KYC authenticated',
    ],
  },
];

export function getCitizensForAdmin(_adminUsername?: string): AdminCitizen[] {
  // Return all citizens for universal search and management across all admin officers
  return ALL_CITIZENS;
}
