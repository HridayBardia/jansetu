          ...
          >
            ...
            <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
              ...
              <div className="flex flex-wrap items-center md:flex-col md:items-end gap-2 pt-2 md:pt-0 border-t md:border-t-0 border-slate-800">
                ...
                {!isCompleted && !isBlocked && (
                  ...
                  >
                    <span>{step.consequential ? "{t('workflow.reviewConfirm')}" : "{t('workflow.markCompleted')}"}</span>
            ...
            {step.required_documents && step.required_documents.length > 0 && (
              <div className="mt-4 pt-3 border-t border-slate-800/80">
                <h4 className="text-xs font-bold text-slate-300 mb-2 flex items-center gap-1.5">
                  ...
                  <span>{t("workflow.requiredDocs")}</span>
                </h4>
                    ...
                    >
                      ...
                      {doc.status === 'available' ? (
                        ...
                        >
                          ...
                          <span>{t('documents.uploadSandbox')}</span>
                        </button>
                      )}
                    </div>
                  ))}
            ...
            {step.official_sources && step.official_sources.length > 0 && (
              <div className="mt-3 flex items-center gap-2 text-xs">
                <span className="text-slate-400 font-medium">{t("workflow.officialSource")}</span>
